...
const homeTestimonials = [
  ...
  {
    name: 'Hassan Farah',
    company: 'HORN EXCELLENCE CONSULTANCY',
...
const Home = () => {
  return (
      ...
      <div className="relative w-full z-10">
        <div className="text-center py-16 bg-[#f8f9fa]">
          ...
          <div className="relative">
            {/* Left Arrow - Inside section */}
            <button 
              onClick={() => {
                const container = document.getElementById('service-carousel');
                if (container) container.scrollLeft -= window.innerWidth;
              }}
              className="absolute left-4 top-1/2 -translate-y-1/2 z-20 w-12 h-12 rounded-full bg-white/20 backdrop-blur-md text-white flex items-center justify-center hover:bg-white/40 transition-all duration-300 border border-white/30"
            >
                  ...
                  <div className="absolute inset-0 flex items-center">
                    <div className="pl-[10%] md:pl-[8%]">
                      <div className="flex items-center gap-3 mb-4">
                        <span className="text-[#e11d48] text-sm font-black tracking-widest uppercase">
                          0{index + 1}
                        </span>
                        <div className="w-12 h-[2px] bg-[#e11d48]" />
                      </div>
                      ...
                      <Link 
                        ...
                        className="inline-flex items-center gap-2 text-white font-bold text-sm uppercase tracking-widest border-b-2 border-white/50 hover:border-white transition-all pb-2"
                      >
                        Explore Service
            ...
            {/* Right Arrow - Inside section */}
            <button 
              onClick={() => {
                const container = document.getElementById('service-carousel');
                if (container) container.scrollLeft += window.innerWidth;
              }}
              className="absolute right-4 top-1/2 -translate-y-1/2 z-20 w-12 h-12 rounded-full bg-white/20 backdrop-blur-md text-white flex items-center justify-center hover:bg-white/40 transition-all duration-300 border border-white/30"
            >
        ...
        <section className="relative w-full bg-white py-32 overflow-hidden z-10">
    ...
    <section className="relative w-full bg-white py-32 overflow-hidden border-t border-gray-100">
